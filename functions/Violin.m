classdef Violin < handle
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            obj.ScatterPlot = ...
                scatter(pos + jitter.*jitterstrength, data, 30, 'filled'); % change marker size
    ...
    methods (Access=private)
        function results = checkInputs(obj, data, pos, varargin)
            ...
            p.addParameter('MedianColor', [1 1 1], iscolor);    % default transparnecy is 0.3
            p.addParameter('ViolinAlpha', 1, isscalarnumber);   % change violin transparency, to 1 for proper .eps output
