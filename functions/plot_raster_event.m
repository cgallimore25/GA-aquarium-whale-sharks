function h = plot_raster_event(x, y, width, linespec, linew)
...
if nargin<3 || isempty(width); width=0.85; end
if nargin<4 || isempty(linespec); linespec='-k'; end
...
h= plot([x(:)'; x(:)'], [y(:)'+width/2; y(:)'-width/2], linespec, 'linewidth', linew);
